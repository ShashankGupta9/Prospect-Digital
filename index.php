    ...
    <div class="hero-tech__grid">
      ...
      <div class="dashboard-showcase" data-reveal="scale">
        <div class="dashboard-window">
          ...
          <div class="dash-sidebar">
            <div class="dash-sidebar__logo">
              <div class="dash-sidebar__logo-dot"></div>
              <span>PROSPECT</span>
            </div>
            <div class="dash-sidebar__menu">
              <div class="dash-sidebar__item is-active"><?= icon('layers', 'icon') ?> Dashboard</div>
              <div class="dash-sidebar__item"><?= icon('users', 'icon') ?> Users</div>
              <div class="dash-sidebar__item"><?= icon('target', 'icon') ?> Customers</div>
              <div class="dash-sidebar__item"><?= icon('briefcase', 'icon') ?> Products</div>
              <div class="dash-sidebar__item"><?= icon('chart', 'icon') ?> Reports</div>
              <div class="dash-sidebar__item"><?= icon('cpu', 'icon') ?> Settings</div>
            </div>
          </div>
          ...
          <div class="dash-main">
            <div class="dash-header">
              ...
              <span class="muted" style="font-size:0.75rem;">Real-time overview</span>
            </div>

            <!-- Metric Cards -->
            <div class="dash-stats-row">
              <div class="dash-stat-card">
                <div class="dash-stat-card__label">Total Revenue</div>
                <div class="dash-stat-card__val">
                  <span>₹ 2,48,000</span>
                  <span class="dash-stat-card__growth">+12%</span>
                </div>
              </div>
              <div class="dash-stat-card">
                ...
                <div class="dash-stat-card__val">
                  <span>1,248</span>
                  <span class="dash-stat-card__growth">+8%</span>
                </div>
              </div>
              <div class="dash-stat-card">
                <div class="dash-stat-card__label">Active Customers</div>
                <div class="dash-stat-card__val">
                  <span>892</span>
                  <span class="dash-stat-card__growth">+15%</span>
                </div>
              </div>
            </div>
            ...
            <div class="dash-charts-row">
              <div class="dash-chart-card">
                <div class="dash-chart-card__title">Sales Overview</div>
                <svg viewBox="0 0 160 65" width="100%" height="65" style="overflow:visible">
                  <defs>
                  ...
                  <path d="M 0 50 Q 30 25 60 38 T 120 18 T 160 10 L 160 65 L 0 65 Z" fill="url(#chartGrad)"/>
                  <path d="M 0 50 Q 30 25 60 38 T 120 18 T 160 10" fill="none" stroke="#ef4444" stroke-width="2.5" stroke-linecap="round"/>
                  <circle cx="120" cy="18" r="3.5" fill="#ef4444"/>
                  <circle cx="160" cy="10" r="3.5" fill="#ef4444"/>
                </svg>
              </div>

              <div class="dash-chart-card">
                <div class="dash-chart-card__title">Order Status</div>
                <div style="display:flex;align-items:center;justify-content:space-around;height:65px">
                  <svg viewBox="0 0 36 36" width="55" height="55">
                    <circle cx="18" cy="18" r="14" fill="none" stroke="#e2e8f0" stroke-width="4.5"/>
                    <circle cx="18" cy="18" r="14" fill="none" stroke="#ef4444" stroke-width="4.5" stroke-dasharray="60 100" stroke-dashoffset="25"/>
                    <circle cx="18" cy="18" r="14" fill="none" stroke="#0284c7" stroke-width="4.5" stroke-dasharray="25 100" stroke-dashoffset="85"/>
                  </svg>
                  <div style="font-size:0.62rem;color:var(--ink-soft);line-height:1.4">
                    <div><span style="color:#ef4444;">●</span> Completed</div>
                    <div><span style="color:#0284c7;">●</span> Processing</div>
                    <div><span style="color:#cbd5e1;">●</span> Pending</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="floating-workflow-tag">
          ...
          <div>
            <div class="floating-workflow-tag__title">Automate Your Workflow</div>
            <div class="floating-workflow-tag__text">Save time. Reduce errors. Grow faster.</div>
          </div>
        </div>
      </div>
    </div>
